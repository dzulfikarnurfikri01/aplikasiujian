	...
	public function m_soal()
	{
		...
		if ($uri3 == "det") {
			...
			foreach ($q_datanya as $d) {
				...
				$data_ok[3] = "Dipakai : " . ($total) . ", Benar: " . $jml_benar . ", Salah: " . $jml_salah . "<br>Persentase benar : " . number_format($persen_benar) . " %";
	...
	public function m_ujian()
	{
		...
		if ($uri3 == "det") {
			...
			foreach ($q_datanya as $d) {
				...
				$data_ok[7] = '
		            	<div class="btn-group">
                          <a href="#" onclick="return m_ujian_e(' . $d['id'] . ');"class="btn btn-warning	 btn-xs">&nbsp;<i class="glyphicon glyphicon-pencil" style="margin-left: 0px; color: #fff"></i>&nbsp;Edit</a>
