...
<head>
	...
	<meta name="description" content="TEST SELEKSI CALON SISWA SMKN 5 PANDEGLANG">
	<meta name="apple-mobile-web-app-capable" content="yes">
	<link href="<?php echo base_url(); ?>___/css/bootstrap.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>___/css/style.css" rel="stylesheet">
	</link>
	<link rel="icon" type="image/png" href="<?php echo base_url(); ?>___/img/smk5.png">
</head>

<body>

	<div class="" style="min-height: 50px;">
		<nav class="navbar navbar-findcond navbar-fixed-top" style="background-color:#03F; min-height:70px;">
			<div class="container">
				<div class="navbar-header" style="margin-top:10px;">
					<b><a class="navbar-brand" style="color: #fff"><?php echo $this->config->item('nama_aplikasi'); ?></a></b>
				</div>
			</div>
		</nav>
	</div>
	...
	<div class="container">
	  ...
	  <div class="panel panel-default top150">
            ...
            <center><img src="<?php echo base_url('___/img/smk5.png') ?>" width="130px" height="130px"></center><br>
				...
				<div class="login-actions">
					<button class="button btn btn-dafault btn-large col-lg-12 top15" style="background-color:#09F; color:#FFF;">LOGIN</button>
				</div> <!-- .actions -->
			</div>
		</div> <!-- /login-fields -->
	...
	<div class="col-md-12 footer" style="background-color:#03F; color: #fff;">
