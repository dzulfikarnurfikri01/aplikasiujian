...
<head>
   <meta charset="utf-8">
   <title><?php echo $this->config->item('nama_aplikasi') . " " . $this->config->item('versi'); ?></title>
...
<body>
   <div class="" style="min-height:50px;">
      <nav class="navbar navbar-findcond navbar-fixed-top" style="background-color:#03F; min-height:50px; color: #fff; min-height:80px;">
         <div class="container">
            <div class="navbar-header">
               ...
               <a class="navbar-brand"><b>APLIKASI UJIAN CBT <?php echo $this->config->item('nama_sekolah'); ?></b></a>
            </div>
   ...
   <div class="col-md-12 footer" style="background-color: #06F; color: #fff;">
