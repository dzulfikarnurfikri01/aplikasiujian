  ...
  <div class="panel panel-info">
    <div class="panel-heading"><b>DATA SOAL</b>
      <div class="tombol-kanan">
        <a class="btn btn-success btn-sm" href="<?php echo base_url(); ?>adm/m_soal/edit/0"><i class="glyphicon glyphicon-plus" style="margin-left: 0px; color: #fff"></i> &nbsp;&nbsp;Tambah</a>
        ...
        <a class='btn btn-primary btn-sm' target='_blank' href='<?php echo base_url(); ?>adm/m_soal/cetak/<?php echo $uri4; ?>'>
        <i class='glyphicon glyphicon-zoom-in'></i>&nbsp;&nbsp;Review</a>
      </div>
    </div>
